...
<p style="margin-top:30px;">
  <b>
    <strong>
      <a href="{{ site.baseurl }}/files/Foreign_Peers_Effects_JMP_Raghav_Rakesh.pdf" target="_blank">
        <font size="3" style="color:#008208">International Peers in Higher Education and Domestic Students' Outcomes</font>
      </a>
    </strong>
    <br>
  </b>
  <font size="2" style="color:#000000;">Presentations: SEA 2023 </font>
</p>
...
<p style="margin-top:30px;">
  <b>
    <strong>
      <a href="{{ site.baseurl }}/files/Local_Economic_Impacts_of_Foreign_Students.pdf" target="_blank">
...
<p style="margin-top:30px;">
  <b>
    ...
    <br>
    <font size="2" style="color:#000000;">Status: Endline Data Collection Ongoing</font>
  </b>
</p>
